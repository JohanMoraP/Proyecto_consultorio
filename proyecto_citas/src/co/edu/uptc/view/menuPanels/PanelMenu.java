...
public class PanelMenu extends JPanel {
        ...
        private void initComponents(ActionListener listener) {
                ...
                ImageIcon imageMenu = new ImageIcon(
                                ((new ImageIcon("images/cita.png")).getImage()).getScaledInstance(50, 50,
                ...
                btnAppoint.setCursor(new Cursor(Cursor.HAND_CURSOR));
                btnAppoint.addActionListener(listener);
                btnAppoint.setActionCommand("citas");
                add(btnAppoint);

                btnDoctor = new JButton();
                ImageIcon imageDoctor = new ImageIcon(
                                ((new ImageIcon("images/doctores.png")).getImage()).getScaledInstance(50,
                                                50, java.awt.Image.SCALE_SMOOTH));
                ...
                ImageIcon imageUser = new ImageIcon(
                                ((new ImageIcon("images/usuarios.png")).getImage()).getScaledInstance(50,
                                                50, java.awt.Image.SCALE_SMOOTH));
