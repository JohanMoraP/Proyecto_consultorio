...
public class App implements ActionListener{
    ...
    SchedulePanel schedule = new SchedulePanel(this,controlModel.specialityList);
    ...
    SearchUser searchUserAppoin;
    Object[]  dataAppointment= new Object[4];
    ...
    public void actionPerformed(ActionEvent event) {
        ...
        switch (source) {
            ...
            case "guardarCita":
                ...
                controlModel.generalSchedule.scheduleAppoint.add(new Appointment((Doctor)dataAppointment[1], 
                (Patient)dataAppointment[0], fecha, ""+dataAppointment[2]));
